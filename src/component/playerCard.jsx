    ...
    return (
       <div className="border border-[#ddd] p-4 rounded-xl">
        ...
        <div className="flex flex-col justify-between h-1/2">
            ...
            {/* player name  */}
            <div className="flex gap-1 items-center"><CircleUserRound /><p className="font-bold text-xl">{playerName}</p></div>
        ...
        <div className="flex border-b-1 pb-2 mt-2 border-b-[#ddd] justify-between items-center">
            ...
            <div className="  rounded text-[14px] py-1 px-2 bg-[#ddd] ">{playerType}</div>
        </div>

        {/* player rating  */}
        <div className=" text-[16px] mt-2 font-bold">Rating : {rating.toFixed(1)}</div>
